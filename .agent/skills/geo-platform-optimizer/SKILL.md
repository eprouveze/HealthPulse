...
description: Platform-specific AI search optimization — audit and optimize for Google AI Overviews, ChatGPT, Perplexity, Gemini, and Bing Copilot individually. Use when user says 'platform optimization', 'ChatGPT optimization', 'Perplexity', 'Google AI Overviews', 'AIO', 'Gemini', 'Copilot', or wants platform-specific AI search optimization.
version: 1.0.0
