---
name: geo-llmstxt
description: Analyzes and generates llms.txt files -- the emerging standard for helping AI systems understand website structure and content. Can validate existing llms.txt files or generate new ones from scratch by crawling the site. Use when user says 'llms.txt', 'llms-full.txt', 'AI content guide', or wants to create or analyze an llms.txt file.
allowed-tools:
  - Read
  - Grep
  - Glob
