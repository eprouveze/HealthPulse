---
name: geo-report-pdf
description: Generate a professional PDF report from GEO audit data using ReportLab. Creates a polished, client-ready PDF with score gauges, bar charts, platform readiness visualizations, color-coded tables, and prioritized action plans. Use when user says 'PDF report', 'PDF', 'generate PDF', 'professional report', or wants a visual PDF deliverable with charts and gauges.
version: 1.0.0
