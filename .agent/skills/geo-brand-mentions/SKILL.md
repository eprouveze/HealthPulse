...
description: Brand mention and authority scanner for AI visibility. Analyzes brand presence across platforms that AI models rely on for entity recognition and citation decisions. Produces a Brand Authority Score (0-100) with platform-specific recommendations. Use when user mentions 'brand mentions', 'brand authority', 'Reddit presence', 'YouTube mentions', 'Wikipedia check', or wants to assess brand visibility across platforms.
allowed-tools:
  - Read
  - Grep
  - Glob
