---
name: geo-schema
description: Schema.org structured data audit and generation optimized for AI discoverability — detect, validate, and generate JSON-LD markup. Use when user says 'schema', 'structured data', 'JSON-LD', 'schema.org', 'rich results', 'entity markup', or wants to detect, validate, or generate structured data.
version: 1.0.0
