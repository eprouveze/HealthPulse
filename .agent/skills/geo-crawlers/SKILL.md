---
name: geo-crawlers
description: AI crawler access analysis. Checks robots.txt, meta tags, and HTTP headers to determine which AI crawlers can access the site. Provides a complete access map and recommendations for maximizing AI visibility while maintaining appropriate control. Use when user says 'crawlers', 'robots.txt', 'AI bots', 'crawler access', 'blocked bots', or wants to check which AI systems can access their site.
allowed-tools:
  - Read
  - Grep
  - Glob
