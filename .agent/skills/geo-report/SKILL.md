---
name: geo-report
description: Generate a professional, client-facing GEO report combining all audit results into a single deliverable with scores, findings, and prioritized actions. Use when user says 'report', 'client report', 'deliverable', 'generate report', 'client-ready', or wants a professional GEO report for stakeholders.
version: 1.0.0
