---
name: geo-technical
description: Technical SEO audit with GEO-specific checks — crawlability, indexability, security, performance, SSR, and AI crawler access. Use when user says 'technical SEO', 'technical audit', 'page speed', 'Core Web Vitals', 'SSR', 'crawlability', 'security headers', or wants a technical infrastructure assessment.
version: 1.0.0
